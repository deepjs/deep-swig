...
define(["require", "deepjs/deep", "deepjs/lib/cache", "deep-restful/lib/store", "./init"], function(require, deep, cache, Store, init){
	
	deep.swig = deep.swig || swig; // swig should be global in browser
	deep.swig.init = init;
	deep.swig.JQAjax = deep.compose.Classes(Store, function(protocol, basePath, options) {
